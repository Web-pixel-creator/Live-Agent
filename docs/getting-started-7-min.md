...
`local_services_pilot_proof_update_rail` show the current account, next manual
action, and browser-local proof marker to update after the real action. `Category pilot score`,
