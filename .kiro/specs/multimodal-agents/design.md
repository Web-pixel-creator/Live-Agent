...
4. The demo UI SHALL expose assistant lifecycle states (`waiting_connection`, `idle`, `streaming`, `speaking`) and the run SHALL prove this lifecycle via KPI artifact (`assistantActivityLifecycleValidated=true`).
