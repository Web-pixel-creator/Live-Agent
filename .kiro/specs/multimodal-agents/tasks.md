...
| T-011 | Реализовать lifecycle endpoints рантайма (status, warmup, drain, health, version) | P1 | 0.5 day | T-001, T-002 | R10, R11, R14, R15 | Операционные endpoints доступны для gateway/orchestrator, в трассировках фиксируются runtime profile/version |
