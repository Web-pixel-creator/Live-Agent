...
test("local release artifact revalidation script keeps expected source and gate defaults", () => {
  ...
  assert.match(source, /case wiki routing context validated/);
  assert.match(source, /case wiki routing context observed/);
  assert.match(source, /case wiki routing context source/);
  assert.match(source, /case wiki routing context focus id/);
  assert.match(source, /case wiki routing context blocker/);
  assert.match(source, /case wiki routing context next action/);
  assert.match(source, /case wiki routing context route/);
  assert.match(source, /case wiki routing context mode/);
  assert.match(source, /case wiki routing context requested intent/);
  assert.match(source, /case wiki routing context routed intent/);
  assert.match(source, /case wiki context adoption status/);
  assert.match(source, /case wiki context adoption validated/);
  assert.match(source, /case wiki context adoption observed/);
  assert.match(source, /case wiki context adoption observed count/);
  assert.match(source, /case wiki context adoption case-wiki observed count/);
  assert.match(source, /case wiki context adoption input-only observed count/);
  assert.match(source, /case wiki context adoption unknown observed count/);
  assert.match(source, /case wiki context adoption case-wiki rate/);
