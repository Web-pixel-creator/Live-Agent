...
test("operator console exposes compact session boundary widget", () => {
  ...
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationPrep=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationOpenGuard=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationOutcome=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationConfidence=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationDetour=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalation=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationTarget=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationCTA=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationReadiness=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationPrep=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationOpenGuard=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationOutcome=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationConfidence=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationDetour=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalation=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationTarget=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationCTA=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationReadiness=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationPrep=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationOpenGuard=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationOutcome=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationConfidence=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationDetour=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationEscalation=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationEscalationTarget=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationEscalationCTA=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationEscalationReadiness=",
  "firstStepRefreshEscalationFallbackEscalationFallbackEscalationFallbackEscalationEscalationEscalationEscalationPrep=",
...
assert.match(readmeSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation confidence/i);
assert.match(readmeSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation detour/i);
assert.match(readmeSource, /refresh escalation fallback escalation fallback escalation fallback escalation prep hint/i);
assert.match(readmeSource, /refresh escalation fallback escalation fallback escalation fallback escalation open guard/i);
assert.match(readmeSource, /refresh escalation fallback escalation fallback escalation fallback escalation outcome/i);
assert.match(readmeSource, /refresh escalation fallback escalation fallback escalation fallback escalation confidence/i);
assert.match(readmeSource, /refresh escalation fallback escalation fallback escalation fallback escalation detour/i);
...
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation open guard/i);
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation outcome/i);
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation confidence/i);
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation detour/i);
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation prep hint/i);
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation open guard/i);
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation outcome/i);
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation confidence/i);
assert.match(operatorGuideSource, /refresh escalation fallback escalation fallback escalation fallback escalation detour/i);
...
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation prep/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation open guard/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation outcome/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation confidence/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation detour/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation prep hint/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation open guard/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation outcome/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation confidence/i);
assert.match(architectureSource, /refresh escalation fallback escalation fallback escalation fallback escalation detour/i);
