...
test("runtime session replay mirror route stays aligned across API, helper, inventory, and docs", () => {
  ...
  assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback outcome/i);
  assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback confidence/i);
assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback detour/i);
assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback escalation/i);
assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback escalation target/i);
assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback escalation cta/i);
...
assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation confidence/i);
assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation detour/i);
...
assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback escalation confidence/i);
assert.match(readme, /refresh escalation fallback escalation fallback escalation fallback escalation detour/i);
  ...
  assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback outcome/i);
  assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback confidence/i);
assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback detour/i);
assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback escalation/i);
assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback escalation target/i);
assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback escalation cta/i);
...
assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation confidence/i);
assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation detour/i);
...
assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback escalation confidence/i);
assert.match(operatorGuide, /refresh escalation fallback escalation fallback escalation fallback escalation detour/i);
  ...
  assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback outcome/i);
  assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback confidence/i);
assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback detour/i);
assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback escalation/i);
assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback escalation target/i);
assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback escalation cta/i);
...
assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation confidence/i);
assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback escalation escalation escalation escalation detour/i);
...
assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback escalation confidence/i);
assert.match(architecture, /refresh escalation fallback escalation fallback escalation fallback escalation detour/i);
