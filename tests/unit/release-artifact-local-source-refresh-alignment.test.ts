...
test("local source-run refresh helper keeps expected evidence and branch-guard inputs", () => {
  ...
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressStatus/);
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressObserved/);
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressContextSource/);
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressIngressSource/);
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressFocusId/);
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressBlocker/);
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressNextAction/);
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressRoute/);
  assert.match(source, /railwayDeploySummaryCaseWikiRuntimeSurfaceIngressUpdatedAt/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressStatus/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressObserved/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressContextSource/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressIngressSource/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressFocusId/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressBlocker/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressNextAction/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressRoute/);
  assert.match(source, /repoPublishSummaryCaseWikiRuntimeSurfaceIngressUpdatedAt/);
