...
test("release artifact revalidation workflow resolves source artifacts and runs artifact-only gate", () => {
  ...
  assert.match(source, /releaseEvidenceReport\.statuses\.caseWikiRoutingContextStatus/);
  assert.match(source, /releaseEvidenceReport\.caseWikiRoutingContext\.validated/);
  assert.match(source, /releaseEvidenceReport\.caseWikiRoutingContext\.observed/);
  assert.match(source, /releaseEvidenceReport\.caseWikiRoutingContext\.contextSource/);
  assert.match(source, /releaseEvidenceReport\.caseWikiRoutingContext\.focusId/);
  assert.match(source, /releaseEvidenceReport\.caseWikiRoutingContext\.route/);
  ...
  assert.match(source, /releaseEvidenceReport\.caseWikiContextAdoption\.observedCount/);
  assert.match(source, /releaseEvidenceReport\.caseWikiContextAdoption\.caseWikiObservedCount/);
  assert.match(source, /releaseEvidenceReport\.caseWikiContextAdoption\.inputOnlyObservedCount/);
  assert.match(source, /releaseEvidenceReport\.caseWikiContextAdoption\.unknownObservedCount/);
  assert.match(source, /releaseEvidenceReport\.caseWikiContextAdoption\.caseWikiRate/);
  ...
  assert.match(source, /Case-wiki-routing-context status \(badge evidence\):/);
  assert.match(source, /Case-wiki-routing-context validated \(badge evidence\):/);
  assert.match(source, /Case-wiki-routing-context observed \(badge evidence\):/);
  assert.match(source, /Case-wiki-routing-context source \(badge evidence\):/);
  assert.match(source, /Case-wiki-routing-context focus id \(badge evidence\):/);
  assert.match(source, /Case-wiki-routing-context blocker \(badge evidence\):/);
  assert.match(source, /Case-wiki-routing-context next action \(badge evidence\):/);
  assert.match(source, /Case-wiki-routing-context route \(badge evidence\):/);
  ...
  assert.match(source, /Case-wiki-context-adoption observed count \(badge evidence\):/);
  assert.match(source, /Case-wiki-context-adoption case-wiki observed count \(badge evidence\):/);
  assert.match(source, /Case-wiki-context-adoption input-only observed count \(badge evidence\):/);
  assert.match(source, /Case-wiki-context-adoption unknown observed count \(badge evidence\):/);
  assert.match(source, /Case-wiki-context-adoption case-wiki rate \(badge evidence\):/);
