...
test("runbook critical evidence list is aligned with release-readiness checks", () => {
  ...
  const requiredCriticalKpis = [
    ...
    "operatorAgentUsageSummaryValidated",
    ...
    "governancePolicyLifecycleValidated",
    "governancePolicyOperatorActionSeen",
    "governancePolicyOverrideTenantSeen",
    "skillsRegistryLifecycleValidated",
    "skillsRegistryIndexHasSkill",
    "skillsRegistryRegistryHasSkill",
    "operatorPluginMarketplaceLifecycleValidated",
