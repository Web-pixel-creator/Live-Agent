...
test("operator console exposes a productized workspace chooser and route-aware workspace header above the board toolbar", () => {
  ...
  for (const token of [
    ...
    'id="operatorWorkspaceOverviewFocusValue"',
    ...
    'id="operatorWorkspaceApprovalsFocusValue"',
    ...
    'id="operatorWorkspaceRuntimeFocusValue"',
    ...
    'id="operatorWorkspaceAuditFocusValue"',
    'class="operator-workspace-card-focus-label">Focus</span>',
