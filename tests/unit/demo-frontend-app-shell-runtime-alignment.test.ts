...
test("live desk exposes the seven-minute visa intake product path", () => {
  ...
  const localServicesAgentHandoff = readRepoSource("docs/local-services-agent-handoff.md");
  const localServicesWorkspaceAdapter = readAppShellSource("lib/local-services-workspace-adapter.ts");
  const localServicesScenarios = readAppShellSource("lib/local-services-scenarios.ts");
  const apiLocalServicesWorkspace = readRepoSource("apps/api-backend/src/local-services-workspace.ts");
  const apiBackendIndex = readRepoSource("apps/api-backend/src/index.ts");
  ...
  assert.match(liveDesk, /min-\[1600px\]:grid-cols-\[minmax\(600px,1fr\)_minmax\(520px,540px\)\]/);
  assert.match(liveDesk, /bg-background\/35 min-\[1600px\]:h-\[calc\(100vh-8rem\)\] min-\[1600px\]:min-h-\[640px\]/);
  assert.match(liveDesk, /bg-card\/80 min-\[1600px\]:sticky min-\[1600px\]:top-4 min-\[1600px\]:h-\[calc\(100vh-8rem\)\]/);
  ...
  assert.match(liveDesk, /md:grid-cols-\[48px_minmax\(0,1fr\)_minmax\(188px,204px\)\]/);
  assert.match(liveDesk, /xl:grid-cols-\[48px_minmax\(0,1fr\)_minmax\(196px,204px\)\]/);
  assert.match(liveDesk, /lg:grid-cols-\[minmax\(150px,220px\)_minmax\(110px,170px\)_auto_minmax\(0,1fr\)\]/);
  assert.match(liveDesk, /md:max-w-\[204px\] md:flex-col md:items-stretch/);
  assert.match(liveDesk, /Dispatcher compact request queue/);
  assert.match(liveDesk, /Selected request decision rail/);
  assert.match(liveDesk, /Request rail compact stack/);
  ...
  assert.match(liveDesk, /shrink-0 border-t border-border\/60 bg-card\/95 px-3\.5 py-2\.5/);
  ...
  assert.match(readme, /520-540px` decision rail/);
  assert.match(readme, /min-width: 1600px/);
  assert.match(operatorGuide, /fixed-height shell, independent scroll body/);
  assert.match(operatorGuide, /Request rail compact stack/);
  assert.match(operatorGuide, /Decision rail compact stack/);
  assert.match(operatorGuide, /188-204px` for row\s+actions/);
  assert.match(operatorGuide, /min-width: 1600px/);
  ...
  assert.match(localServicesAgentHandoff, /minmax\(188px, 204px\)/);
  assert.match(localServicesAgentHandoff, /min-width: 1600px/);
  ...
  assert.match(localServicesAgentHandoff, /Operator outcome log/);
  assert.match(localServicesAgentHandoff, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(localServicesAgentHandoff, /Outreach outcome trail/);
  assert.match(localServicesAgentHandoff, /outreach_outcome_trail/);
  assert.match(localServicesSpec, /Two-line compact row/);
  assert.match(localServicesSpec, /minmax\(188px, 204px\) action grid/);
  assert.match(localServicesSpec, /min-width: 1600px/);
  ...
  assert.match(localServicesDeveloperMap, /minmax\(188px, 204px\)/);
  assert.match(localServicesDeveloperMap, /min-width: 1600px/);
  ...
  assert.match(localServicesDeveloperMap, /Operator outcome log/);
  assert.match(localServicesDeveloperMap, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(localServicesDeveloperMap, /Outreach outcome trail/);
  assert.match(localServicesDeveloperMap, /outreach_outcome_trail/);
  ...
  assert.match(liveDesk, /type LocalServiceDispatchApprovalDecision =/);
  assert.match(liveDesk, /const LOCAL_SERVICE_DISPATCH_APPROVAL_LABELS:/);
  assert.match(liveDesk, /dispatchApprovalByService/);
  assert.match(liveDesk, /operatorDecisionByCaseRef/);
  assert.match(liveDesk, /selectedOperatorDecision/);
  assert.match(liveDesk, /selectedOperatorDecisionSurface/);
  assert.match(liveDesk, /selectedOperatorDecisionTime/);
  assert.match(liveDesk, /Workspace record/);
  assert.match(liveDesk, /API \+ local fallback/);
  assert.match(liveDesk, /mapDispatchApprovalToOperatorAction/);
  assert.match(liveDesk, /localServicesWorkspaceAdapter\.updateCaseDecision/);
  assert.match(liveDesk, /const schedulePlannerRows =/);
  assert.match(liveDesk, /const schedulePlannerKpis =/);
  assert.match(liveDesk, /Approval-ready slot planner/);
  assert.match(liveDesk, /Schedule compact slot planner/);
  assert.match(liveDesk, /Click selects slot preview/);
  ...
  assert.match(liveDesk, /Copy schedule handoff/);
  assert.match(liveDesk, /Approve manual handoff/);
  assert.match(liveDesk, /No external booking/);
  assert.match(liveDesk, /type LocalServiceCustomerConfirmationDecision =/);
  assert.match(liveDesk, /const LOCAL_SERVICE_CUSTOMER_CONFIRMATION_LABELS:/);
  assert.match(liveDesk, /customerConfirmationByService/);
  assert.match(liveDesk, /Customer directory workbench/);
  assert.match(liveDesk, /Customer compact directory/);
  assert.match(liveDesk, /LAST = service \+ ref/);
  assert.match(liveDesk, /Select customer preview/);
  assert.match(liveDesk, /Open customer drawer is the explicit full action/);
  assert.match(liveDesk, /С контактами/);
  ...
  assert.match(liveDesk, /Copy 7-minute launch path/);
  assert.match(liveDesk, /Record current step reviewed/);
  ...
  assert.match(liveDesk, /operator_approved_manual_contact_packet_with_7_minute_bridge/);
  ...
  assert.match(liveDesk, /setupEvents/);
  assert.match(liveDesk, /latestSetupRecord/);
  assert.match(liveDesk, /Latest setup record/);
  assert.match(liveDesk, /appendLocalServiceSetupEvent/);
  assert.match(liveDesk, /localServicesWorkspaceAdapter\.recordSetupStep/);
  ...
  assert.match(liveDesk, /Next setup action/);
  assert.match(liveDesk, /Setup validation checklist/);
  assert.match(liveDesk, /requiredInputs/);
  assert.match(liveDesk, /validationRule/);
  assert.match(liveDesk, /operatorAction/);
  assert.match(liveDesk, /Complete current step/);
  assert.match(liveDesk, /Current step/);
  assert.match(liveDesk, /Required inputs/);
  assert.match(liveDesk, /Validation rule/);
  assert.match(liveDesk, /Side-effect boundary/);
  assert.match(liveDesk, /No channel activation, no CRM write, no dispatch, no billing/);
  ...
  assert.match(liveDesk, /Pilot launch packet readiness rail/);
  assert.match(liveDesk, /First manual contact packet/);
  assert.match(liveDesk, /First manual contact checklist/);
  assert.match(liveDesk, /Manual contact copy preview/);
  assert.match(liveDesk, /Launch packet guardrails/);
  assert.match(liveDesk, /Launch packet support details/);
  assert.match(liveDesk, /Open Preview \/ Test message/);
  ...
  assert.match(liveDesk, /Operator outcome log/);
  assert.match(liveDesk, /type LocalServiceOutreachOutcomeTrailRow = \{/);
  assert.match(liveDesk, /type LocalServiceOutreachOutcomeTrailState = Pick/);
  assert.match(liveDesk, /function buildLocalServiceOutreachOutcomeTrail\(/);
  assert.match(liveDesk, /formatLocalServiceOutcomeBoolean/);
  assert.match(liveDesk, /Outreach outcome trail/);
  assert.match(liveDesk, /outreach_outcome_trail/);
  assert.match(liveDesk, /selected_draft/);
  assert.match(liveDesk, /preview_reviewed/);
  assert.match(liveDesk, /message_copied/);
  assert.match(liveDesk, /contacted_manually/);
  assert.match(liveDesk, /browser-local state only/);
  assert.match(liveDesk, /Copy selected draft/);
  assert.match(liveDesk, /Mark contacted manually/);
  assert.match(liveDesk, /onRecordMessageCopied=\{updateSelectedOutreachContactPacketCopied\}/);
  assert.match(liveDesk, /onRecordManualContacted=\{updateSelectedOutreachManualContacted\}/);
  assert.match(liveDesk, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(liveDesk, /operator_outcome_log_browser_local_only/);
  ...
  assert.match(liveDesk, /Outreach readiness rail/);
  assert.match(liveDesk, /Next outreach action/);
  assert.match(liveDesk, /Manual outreach boundary/);
  assert.match(liveDesk, /No outbound send, no CRM write, no scorecard mutation, no calendar event/);
  assert.match(liveDesk, /Mark preview reviewed/);
  assert.match(liveDesk, /Pilot outreach preview reviewed/);
  assert.match(liveDesk, /updateSelectedOutreachMessagePreviewReviewed/);
  ...
  assert.match(liveDesk, /Preview reviewed/);
  ...
  assert.match(liveDesk, /messagePreviewReviewedByProspectKey/);
  assert.match(liveDesk, /prep_review/);
  assert.match(liveDesk, /LOCAL_SERVICES_WORKSPACE_STORAGE_KEY/);
  assert.match(liveDesk, /LOCAL_SERVICE_PILOT_WORKSPACE_STORAGE_KEY = LOCAL_SERVICES_WORKSPACE_STORAGE_KEY/);
  assert.match(localServicesWorkspaceAdapter, /LOCAL_SERVICES_WORKSPACE_STORAGE_KEY = "liveDesk:localServicesPilotWorkspace:v1"/);
  assert.match(localServicesWorkspaceAdapter, /export type LocalServicesWorkspaceAdapter = \{/);
  assert.match(localServicesWorkspaceAdapter, /createStaticLocalServicesWorkspaceAdapter/);
  assert.match(localServicesWorkspaceAdapter, /createBrowserLocalServicesWorkspaceAdapter/);
  assert.match(localServicesWorkspaceAdapter, /createApiLocalServicesWorkspaceAdapter/);
  assert.match(localServicesWorkspaceAdapter, /createHybridLocalServicesWorkspaceAdapter/);
  assert.match(localServicesWorkspaceAdapter, /fetchRuntimeApi/);
  assert.match(localServicesWorkspaceAdapter, /\/v1\/local-services\/workspace/);
  assert.match(localServicesWorkspaceAdapter, /\/v1\/local-services\/cases/);
  assert.match(localServicesWorkspaceAdapter, /\/v1\/local-services\/cases\/:ref\/decision/);
  assert.match(localServicesWorkspaceAdapter, /\/v1\/local-services\/setup\/events/);
  assert.match(localServicesWorkspaceAdapter, /\/v1\/local-services\/pilot\/export/);
  assert.match(localServicesWorkspaceAdapter, /updateCaseDecision\(ref, decision\)/);
  assert.match(localServicesWorkspaceAdapter, /saveScenarioOverrides\(scenarios\)/);
  assert.match(localServicesWorkspaceAdapter, /recordSetupStep\(stepId, payload\)/);
  assert.match(localServicesWorkspaceAdapter, /DEFAULT_LOCAL_SERVICES_SCENARIOS/);
  assert.match(localServicesWorkspaceAdapter, /mergeLocalServicesScenarioOverrides/);
  assert.match(apiLocalServicesWorkspace, /LOCAL_SERVICES_WORKSPACE_STORAGE_KEY = "liveDesk:localServicesPilotWorkspace:v1"/);
  assert.match(apiLocalServicesWorkspace, /writeLocalServicesWorkspace/);
  assert.match(apiLocalServicesWorkspace, /saveLocalServicesScenarioOverrides/);
  assert.match(apiLocalServicesWorkspace, /recordLocalServicesCaseDecision/);
  assert.match(apiLocalServicesWorkspace, /recordLocalServicesSetupEvent/);
  assert.match(apiLocalServicesWorkspace, /buildLocalServicesPilotExport/);
  assert.match(apiBackendIndex, /\/v1\/local-services\/workspace/);
  assert.match(apiBackendIndex, /\/v1\/local-services\/scenarios/);
  assert.match(apiBackendIndex, /\/v1\/local-services\/cases\/:ref\/decision/);
  assert.match(localServicesScenarios, /LOCAL_SERVICES_SCENARIO_IDS/);
  assert.match(localServicesScenarios, /localServicesScenarioSchema/);
  assert.match(localServicesScenarios, /DEFAULT_LOCAL_SERVICES_SCENARIOS/);
  assert.match(localServicesScenarios, /ac-repair-dispatch/);
  assert.match(localServicesScenarios, /plumbing-emergency/);
  assert.match(localServicesScenarios, /cleaning-quote-booking/);
  assert.match(localServicesScenarios, /measurement-visit-booking/);
  assert.match(localServicesScenarios, /mergeLocalServicesScenarioOverrides/);
  assert.match(localServicesScenarios, /stock_promise/);
  assert.match(liveDesk, /Scenario modal/);
  assert.match(liveDesk, /LocalServiceScenarioModal/);
  assert.match(liveDesk, /local_services_scenario_modal/);
  assert.match(liveDesk, /Chat dialogue/);
  assert.match(liveDesk, /Structured job card/);
  assert.match(liveDesk, /Final handoff and approval state/);
  assert.match(liveDesk, /Export scenarios JSON/);
  assert.match(liveDesk, /Import scenario JSON/);
  assert.match(liveDesk, /Reset overrides/);
  assert.match(liveDesk, /No scenario create\/delete/);
  assert.match(liveDesk, /scenarioOverrides/);
  assert.match(liveDesk, /parseLocalServicesScenarioList\(JSON\.parse\(scenarioJsonDraft\)\)/);
  assert.match(liveDesk, /localServicesWorkspaceAdapter\.saveScenarioOverrides\(nextScenarios\)/);
  assert.match(liveDesk, /localServicesWorkspaceAdapter\.saveScenarioOverrides\(\[\]\)/);
  assert.match(liveDesk, /createHybridLocalServicesWorkspaceAdapter/);
  assert.match(liveDesk, /localServicesWorkspaceAdapter[\s\S]*\.readSnapshot\(\)/);
  assert.match(liveDesk, /localServicesWorkspaceAdapter[\s\S]*\.writeSnapshot/);
  ...
  assert.match(liveDesk, /outreachOutcomeTrail/);
  assert.match(liveDesk, /Confirm the outreach outcome trail/);
  ...
  assert.match(liveDesk, /local_services_workspace_api/);
  assert.match(liveDesk, /browser_local_preview/);
  assert.match(liveDesk, /localServicesWorkspaceAdapter[\s\S]*\.exportPilotPacket\(\)/);
  assert.match(liveDesk, /buildLocalServiceWorkspaceApiExportView\(workspaceApiExportPacket, pilotWorkspaceState\)/);
  ...
  assert.match(liveDesk, /Open communication preview/);
  assert.match(liveDesk, /Pilot communication preview/);
  assert.match(liveDesk, /local_services_pilot_communication_preview/);
  assert.match(liveDesk, /Selected outcome draft/);
  assert.match(liveDesk, /Confirm the preview\/copy\/manual-contact outcome trail/);
  assert.match(liveDesk, /Copy communication preview/);
  assert.match(liveDesk, /Manual communication approval gate/);
  assert.match(liveDesk, /currentOpsAccountKey/);
  assert.match(liveDesk, /Current account picker/);
  ...
  assert.match(liveDesk, /Current account contact packet/);
  assert.match(liveDesk, /local_services_current_account_contact_packet/);
  assert.match(liveDesk, /Ready for manual contact/);
  assert.match(liveDesk, /contactPacketCopiedByProspectKey/);
  assert.match(liveDesk, /Packet copied/);
  assert.match(liveDesk, /Reset packet review/);
  assert.match(liveDesk, /Packet needed/);
  assert.match(liveDesk, /Copy contact packet/);
  ...
  assert.match(liveDesk, /Continue gate/);
  assert.match(liveDesk, /Current account outcome capture/);
  assert.match(liveDesk, /local_services_current_account_outcome_capture/);
  assert.match(liveDesk, /Outcome needed/);
  assert.match(liveDesk, /Waiting for manual contact/);
  assert.match(liveDesk, /firstRequestOutcomeByProspectKey/);
  assert.match(liveDesk, /Reset current outcome/);
  assert.match(liveDesk, /Current account scorecard sync preview/);
  assert.match(liveDesk, /local_services_current_account_scorecard_sync_preview/);
  assert.match(liveDesk, /Ready for manual scorecard sync/);
  assert.match(liveDesk, /Waiting for outcome/);
  assert.match(liveDesk, /Copy scorecard row/);
  ...
  assert.match(liveDesk, /Current account batch review handoff/);
  assert.match(liveDesk, /local_services_current_account_batch_review_handoff/);
  assert.match(liveDesk, /Ready for batch review handoff/);
  assert.match(liveDesk, /Batch handoff copied/);
  assert.match(liveDesk, /Blocked by batch handoff/);
  assert.match(liveDesk, /Copy batch handoff/);
  assert.match(liveDesk, /Reset batch handoff review/);
  assert.match(liveDesk, /batchReviewHandoffCopiedByProspectKey/);
  ...
  assert.match(liveDesk, /Current account mini-audit/);
  assert.match(liveDesk, /local_services_current_account_mini_audit/);
  assert.match(liveDesk, /No browser-local events yet for this account/);
  assert.match(liveDesk, /Open account history/);
  assert.match(liveDesk, /Account history drawer/);
  assert.match(liveDesk, /local_services_account_history_drawer/);
  assert.match(liveDesk, /Copy account history/);
  ...
  assert.match(demoFrontendServer, /local-services-agent-handoff\.md/);
  ...
  assert.match(readme, /Next setup action/);
  assert.match(readme, /Setup validation checklist/);
  assert.match(readme, /Required inputs/);
  assert.match(readme, /Validation rule/);
  assert.match(readme, /Side-effect boundary/);
  assert.match(readme, /Complete current step/);
  ...
  assert.match(readme, /Pilot launch packet readiness\s+rail/);
  assert.match(readme, /Manual contact copy preview/);
  assert.match(readme, /Launch packet guardrails/);
  assert.match(readme, /Launch packet support details/);
  assert.match(readme, /Open Preview \/ Test message/);
  ...
  assert.match(readme, /Operator outcome log/);
  assert.match(readme, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(readme, /Outreach outcome trail/);
  assert.match(readme, /outreach_outcome_trail/);
  ...
  assert.match(readme, /Outreach readiness rail/);
  assert.match(readme, /Next outreach\s+action/);
  assert.match(readme, /Manual outreach boundary/);
  ...
  assert.match(readme, /selected draft/);
  assert.match(readme, /Open workspace API export/);
  assert.match(readme, /Workspace API export drawer/);
  assert.match(readme, /Copy workspace API\s+export/);
  assert.match(readme, /workspace API \+ local fallback/);
  assert.match(readme, /local_services_workspace_api/);
  assert.match(readme, /browser_local_preview/);
  assert.match(readme, /Manual activity log/);
  assert.match(readme, /Last manual action/);
  ...
  assert.match(readme, /Open communication preview/);
  assert.match(readme, /local_services_pilot_communication_preview/);
  assert.match(readme, /Current account\s+picker/);
  ...
  assert.match(readme, /local_services_current_account_contact_packet/);
  assert.match(readme, /contactPacketCopiedByProspectKey/);
  assert.match(readme, /Reset packet\s+review/);
  assert.match(readme, /Current account\s+action path/);
  assert.match(readme, /local_services_current_account_action_path/);
  assert.match(readme, /local_services_current_account_outcome_capture/);
  assert.match(readme, /firstRequestOutcomeByProspectKey/);
  assert.match(readme, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(readme, /batch_handoff_copied/);
  ...
  assert.match(readme, /local_services_current_account_mini_audit/);
  assert.match(readme, /Open account history/);
  assert.match(readme, /local_services_account_history_drawer/);
  ...
  assert.match(readme, /docs\/local-services-agent-handoff\.md/);
  assert.match(readme, /local-services-scenarios\.ts/);
  assert.match(readme, /local_services_scenario_modal/);
  assert.match(readme, /Export scenarios JSON/);
  assert.match(productMasterPlan, /docs\/local-services-developer-map\.md/);
  assert.match(productMasterPlan, /docs\/local-services-agent-handoff\.md/);
  ...
  assert.match(localDevelopment, /7-minute gate/);
  assert.match(localDevelopment, /operator_approved_manual_contact_packet_with_7_minute_bridge/);
  ...
  assert.match(localDevelopment, /Next setup action/);
  assert.match(localDevelopment, /Setup validation checklist/);
  assert.match(localDevelopment, /Required inputs/);
  assert.match(localDevelopment, /Validation rule/);
  assert.match(localDevelopment, /Side-effect boundary/);
  assert.match(localDevelopment, /Complete current step/);
  ...
  assert.match(localDevelopment, /Pilot launch packet readiness\s+rail/);
  assert.match(localDevelopment, /Manual contact copy preview/);
  assert.match(localDevelopment, /Launch packet guardrails/);
  assert.match(localDevelopment, /Launch packet support details/);
  assert.match(localDevelopment, /Open Preview \/ Test message/);
  ...
  assert.match(localDevelopment, /Operator outcome log/);
  assert.match(localDevelopment, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(localDevelopment, /Outreach outcome trail/);
  assert.match(localDevelopment, /outreach_outcome_trail/);
  ...
  assert.match(localDevelopment, /Outreach readiness rail/);
  assert.match(localDevelopment, /Next outreach\s+action/);
  assert.match(localDevelopment, /Manual outreach boundary/);
  ...
  assert.match(localDevelopment, /Open workspace API export/);
  assert.match(localDevelopment, /Workspace API export drawer/);
  assert.match(localDevelopment, /local_services_workspace_api/);
  assert.match(localDevelopment, /browser_local_preview/);
  ...
  assert.match(localDevelopment, /Open communication preview/);
  assert.match(localDevelopment, /local_services_pilot_communication_preview/);
  assert.match(localDevelopment, /Current account\s+picker/);
  ...
  assert.match(localDevelopment, /local_services_current_account_contact_packet/);
  assert.match(localDevelopment, /contactPacketCopiedByProspectKey/);
  assert.match(localDevelopment, /Reset packet\s+review/);
  ...
  assert.match(localDevelopment, /local_services_current_account_outcome_capture/);
  assert.match(localDevelopment, /firstRequestOutcomeByProspectKey/);
  assert.match(localDevelopment, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(localDevelopment, /local_services_current_account_batch_review_handoff/);
  assert.match(localDevelopment, /Copy batch\s+handoff/);
  assert.match(localDevelopment, /batchReviewHandoffCopiedByProspectKey/);
  ...
  assert.match(localDevelopment, /local_services_current_account_mini_audit/);
  assert.match(localDevelopment, /Open account history/);
  assert.match(localDevelopment, /local_services_account_history_drawer/);
  ...
  assert.match(localDevelopment, /http:\/\/localhost:3000\/workspace-docs\/local-services-agent-handoff\.md/);
  assert.match(localDevelopment, /local_services_scenario_modal/);
  assert.match(localDevelopment, /Reset overrides/);
  ...
  assert.match(operatorGuide, /Approval-ready slot planner/);
  assert.match(operatorGuide, /Schedule compact slot planner/);
  ...
  assert.match(operatorGuide, /Pilot launch packet readiness\s+rail/);
  assert.match(operatorGuide, /Manual contact copy preview/);
  assert.match(operatorGuide, /Launch packet guardrails/);
  assert.match(operatorGuide, /Launch packet support details/);
  assert.match(operatorGuide, /Open Preview \/ Test message/);
  ...
  assert.match(operatorGuide, /Next setup action/);
  assert.match(operatorGuide, /Setup validation checklist/);
  assert.match(operatorGuide, /Required inputs/);
  assert.match(operatorGuide, /Validation rule/);
  assert.match(operatorGuide, /Side-effect boundary/);
  assert.match(operatorGuide, /Complete current step/);
  ...
  assert.match(operatorGuide, /Operator outcome log/);
  assert.match(operatorGuide, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(operatorGuide, /Outreach outcome trail/);
  assert.match(operatorGuide, /outreach_outcome_trail/);
  ...
  assert.match(operatorGuide, /Outreach readiness rail/);
  assert.match(operatorGuide, /Next outreach\s+action/);
  assert.match(operatorGuide, /Manual outreach boundary/);
  ...
  assert.match(operatorGuide, /Open workspace API export/);
  ...
  assert.match(operatorGuide, /Open communication preview/);
  assert.match(operatorGuide, /local_services_pilot_communication_preview/);
  assert.match(operatorGuide, /Current account\s+picker/);
  ...
  assert.match(operatorGuide, /local_services_current_account_contact_packet/);
  assert.match(operatorGuide, /contactPacketCopiedByProspectKey/);
  assert.match(operatorGuide, /Reset packet\s+review/);
  ...
  assert.match(operatorGuide, /local_services_current_account_outcome_capture/);
  assert.match(operatorGuide, /firstRequestOutcomeByProspectKey/);
  assert.match(operatorGuide, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(operatorGuide, /local_services_current_account_mini_audit/);
  assert.match(operatorGuide, /Open account history/);
  assert.match(operatorGuide, /local_services_account_history_drawer/);
  ...
  assert.match(simplificationPlan, /Next setup action/);
  assert.match(simplificationPlan, /Setup validation checklist/);
  assert.match(simplificationPlan, /Required inputs/);
  assert.match(simplificationPlan, /Validation rule/);
  assert.match(simplificationPlan, /Side-effect boundary/);
  assert.match(simplificationPlan, /Complete current step/);
  ...
  assert.match(simplificationPlan, /Operator outcome log/);
  assert.match(simplificationPlan, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(simplificationPlan, /Outreach outcome trail/);
  assert.match(simplificationPlan, /outreach_outcome_trail/);
  ...
  assert.match(simplificationPlan, /Outreach readiness rail/);
  assert.match(simplificationPlan, /Next outreach\s+action/);
  assert.match(simplificationPlan, /Manual outreach boundary/);
  ...
  assert.match(simplificationPlan, /Open communication preview/);
  assert.match(simplificationPlan, /local_services_pilot_communication_preview/);
  assert.match(simplificationPlan, /Current account\s+picker/);
  ...
  assert.match(simplificationPlan, /local_services_current_account_contact_packet/);
  assert.match(simplificationPlan, /contactPacketCopiedByProspectKey/);
  assert.match(simplificationPlan, /Reset packet\s+review/);
  ...
  assert.match(simplificationPlan, /local_services_current_account_outcome_capture/);
  assert.match(simplificationPlan, /firstRequestOutcomeByProspectKey/);
  assert.match(simplificationPlan, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(simplificationPlan, /batch_handoff_copied/);
  ...
  assert.match(simplificationPlan, /local_services_current_account_mini_audit/);
  assert.match(simplificationPlan, /Open account history/);
  assert.match(simplificationPlan, /local_services_account_history_drawer/);
  ...
  assert.match(gettingStarted, /Next setup action/);
  assert.match(gettingStarted, /Setup validation checklist/);
  assert.match(gettingStarted, /Required inputs/);
  assert.match(gettingStarted, /Validation rule/);
  assert.match(gettingStarted, /Side-effect boundary/);
  assert.match(gettingStarted, /Complete current step/);
  ...
  assert.match(gettingStarted, /Operator outcome log/);
  assert.match(gettingStarted, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(gettingStarted, /Outreach outcome trail/);
  assert.match(gettingStarted, /outreach_outcome_trail/);
  ...
  assert.match(gettingStarted, /Outreach readiness rail/);
  assert.match(gettingStarted, /Next outreach\s+action/);
  assert.match(gettingStarted, /Manual outreach boundary/);
  ...
  assert.match(gettingStarted, /Open workspace API export/);
  ...
  assert.match(gettingStarted, /Open communication preview/);
  assert.match(gettingStarted, /local_services_pilot_communication_preview/);
  assert.match(gettingStarted, /Current account\s+picker/);
  ...
  assert.match(gettingStarted, /local_services_current_account_contact_packet/);
  assert.match(gettingStarted, /contactPacketCopiedByProspectKey/);
  assert.match(gettingStarted, /Reset packet\s+review/);
  ...
  assert.match(gettingStarted, /local_services_current_account_outcome_capture/);
  assert.match(gettingStarted, /firstRequestOutcomeByProspectKey/);
  assert.match(gettingStarted, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(gettingStarted, /batch_handoff_copied/);
  ...
  assert.match(gettingStarted, /local_services_current_account_mini_audit/);
  assert.match(gettingStarted, /Open account history/);
  assert.match(gettingStarted, /local_services_account_history_drawer/);
  ...
  assert.match(localServicesSpec, /Next setup action/);
  assert.match(localServicesSpec, /Setup validation checklist/);
  assert.match(localServicesSpec, /requiredInputs/);
  assert.match(localServicesSpec, /validationRule/);
  assert.match(localServicesSpec, /operatorAction/);
  assert.match(localServicesSpec, /Side-effect boundary/);
  assert.match(localServicesSpec, /Complete current step/);
  ...
  assert.match(localServicesSpec, /Pilot launch packet readiness\s+rail/);
  assert.match(localServicesSpec, /Manual contact copy preview/);
  assert.match(localServicesSpec, /Launch packet guardrails/);
  assert.match(localServicesSpec, /Launch packet support details/);
  assert.match(localServicesSpec, /Open Preview \/ Test message/);
  ...
  assert.match(localServicesSpec, /Operator outcome log/);
  assert.match(localServicesSpec, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(localServicesSpec, /Outreach outcome trail/);
  assert.match(localServicesSpec, /outreach_outcome_trail/);
  ...
  assert.match(localServicesSpec, /Outreach readiness rail/);
  assert.match(localServicesSpec, /Next outreach\s+action/);
  assert.match(localServicesSpec, /Manual outreach boundary/);
  ...
  assert.match(localServicesSpec, /Open workspace API export/);
  assert.match(localServicesSpec, /Workspace API export drawer/);
  assert.match(localServicesSpec, /Copy workspace API export/);
  assert.match(localServicesSpec, /local_services_workspace_api/);
  assert.match(localServicesSpec, /browser_local_preview/);
  ...
  assert.match(localServicesSpec, /Open communication preview/);
  assert.match(localServicesSpec, /local_services_pilot_communication_preview/);
  assert.match(localServicesSpec, /Current account\s+picker/);
  ...
  assert.match(localServicesSpec, /local_services_current_account_contact_packet/);
  assert.match(localServicesSpec, /contactPacketCopiedByProspectKey/);
  assert.match(localServicesSpec, /Reset packet\s+review/);
  ...
  assert.match(localServicesSpec, /local_services_current_account_outcome_capture/);
  assert.match(localServicesSpec, /firstRequestOutcomeByProspectKey/);
  assert.match(localServicesSpec, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(localServicesSpec, /local_services_current_account_batch_review_handoff/);
  assert.match(localServicesSpec, /Copy batch\s+handoff/);
  assert.match(localServicesSpec, /batchReviewHandoffCopiedByProspectKey/);
  ...
  assert.match(localServicesSpec, /local_services_current_account_mini_audit/);
  assert.match(localServicesSpec, /Open account history/);
  assert.match(localServicesSpec, /local_services_account_history_drawer/);
  ...
  assert.match(localServicesSpec, /\/workspace-docs\/local-services-agent-handoff\.md/);
  ...
  assert.match(localServicesSpec, /7-minute gate/);
  assert.match(localServicesSpec, /operator_approved_manual_contact_packet_with_7_minute_bridge/);
  ...
  assert.match(localServicesDeveloperMap, /pilotLaunchPacketWithBridge/);
  ...
  assert.match(localServicesDeveloperMap, /Pilot launch packet readiness\s+rail/);
  assert.match(localServicesDeveloperMap, /Manual contact copy preview/);
  assert.match(localServicesDeveloperMap, /Launch packet guardrails/);
  assert.match(localServicesDeveloperMap, /Launch packet support details/);
  assert.match(localServicesDeveloperMap, /Open Preview \/ Test message/);
  ...
  assert.match(pilotScorecard, /Operator outcome\s+log/);
  assert.match(pilotScorecard, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(pilotScorecard, /local_services_current_account_prep_gate/);
  assert.match(pilotScorecard, /local_services_current_account_contact_packet/);
  assert.match(pilotScorecard, /contactPacketCopiedByProspectKey/);
  assert.match(pilotScorecard, /Reset packet\s+review/);
  ...
  assert.match(pilotScorecard, /local_services_current_account_outcome_capture/);
  assert.match(pilotScorecard, /firstRequestOutcomeByProspectKey/);
  assert.match(pilotScorecard, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(pilotScorecard, /local_services_current_account_batch_review_handoff/);
  assert.match(pilotScorecard, /Copy batch\s+handoff/);
  assert.match(pilotScorecard, /batchReviewHandoffCopiedByProspectKey/);
  ...
  assert.match(pilotScorecard, /local_services_current_account_mini_audit/);
  assert.match(pilotScorecard, /Open account history/);
  assert.match(pilotScorecard, /local_services_account_history_drawer/);
  ...
  assert.match(pilotScorecard, /Outreach outcome trail/);
  assert.match(pilotScorecard, /outreach_outcome_trail/);
  assert.match(pilotScorecard, /Open workspace API export/);
  assert.match(pilotScorecard, /Workspace API export drawer/);
  assert.match(pilotScorecard, /Copy workspace API export/);
  assert.match(pilotScorecard, /local_services_workspace_api/);
  assert.match(pilotScorecard, /browser_local_preview/);
  ...
  assert.match(pilotRunbook, /Open communication preview/);
  assert.match(pilotRunbook, /local_services_pilot_communication_preview/);
  ...
  assert.match(pilotRunbook, /Operator outcome\s+log/);
  assert.match(pilotRunbook, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(pilotRunbook, /local_services_current_account_prep_gate/);
  assert.match(pilotRunbook, /local_services_current_account_contact_packet/);
  assert.match(pilotRunbook, /contactPacketCopiedByProspectKey/);
  assert.match(pilotRunbook, /Reset packet\s+review/);
  ...
  assert.match(pilotRunbook, /local_services_current_account_outcome_capture/);
  assert.match(pilotRunbook, /firstRequestOutcomeByProspectKey/);
  assert.match(pilotRunbook, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(pilotRunbook, /Outreach outcome trail/);
  assert.match(pilotRunbook, /outreach_outcome_trail/);
  ...
  assert.match(pilotRunbook, /local_services_current_account_mini_audit/);
  assert.match(pilotRunbook, /Open account history/);
  assert.match(pilotRunbook, /local_services_account_history_drawer/);
  ...
  assert.match(founderExecutionLog, /Operator outcome\s+log/);
  assert.match(founderExecutionLog, /contactProofByProspectKey\.manualMessageSent/);
  assert.match(founderExecutionLog, /local_services_current_account_prep_gate/);
  assert.match(founderExecutionLog, /local_services_current_account_contact_packet/);
  assert.match(founderExecutionLog, /contactPacketCopiedByProspectKey/);
  assert.match(founderExecutionLog, /Reset packet\s+review/);
  ...
  assert.match(founderExecutionLog, /local_services_current_account_outcome_capture/);
  assert.match(founderExecutionLog, /firstRequestOutcomeByProspectKey/);
  assert.match(founderExecutionLog, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(founderExecutionLog, /Outreach outcome trail/);
  assert.match(founderExecutionLog, /outreach_outcome_trail/);
  ...
  assert.match(founderExecutionLog, /local_services_current_account_mini_audit/);
  assert.match(founderExecutionLog, /Open account history/);
  assert.match(founderExecutionLog, /local_services_account_history_drawer/);
  ...
  assert.match(outreachExecutionPack, /Operator outcome\s+log/);
  assert.match(outreachExecutionPack, /contactProofByProspectKey\.manualMessageSent/);
  ...
  assert.match(outreachExecutionPack, /Open communication preview/);
  assert.match(outreachExecutionPack, /local_services_pilot_communication_preview/);
  assert.match(outreachExecutionPack, /Current account\s+picker/);
  ...
  assert.match(outreachExecutionPack, /local_services_current_account_contact_packet/);
  assert.match(outreachExecutionPack, /contactPacketCopiedByProspectKey/);
  assert.match(outreachExecutionPack, /Reset packet\s+review/);
  ...
  assert.match(outreachExecutionPack, /local_services_current_account_outcome_capture/);
  assert.match(outreachExecutionPack, /firstRequestOutcomeByProspectKey/);
  assert.match(outreachExecutionPack, /local_services_current_account_scorecard_sync_preview/);
  ...
  assert.match(outreachExecutionPack, /Outreach outcome trail/);
  assert.match(outreachExecutionPack, /outreach_outcome_trail/);
  ...
  assert.match(localServicesDeveloperMap, /local-services-workspace-adapter\.ts/);
  assert.match(localServicesDeveloperMap, /local-services-scenarios\.ts/);
  assert.match(localServicesDeveloperMap, /local_services_scenario_modal/);
  assert.match(localServicesDeveloperMap, /Final handoff and approval state/);
  ...
  assert.match(localServicesDeveloperMap, /validationRule/);
  assert.match(localServicesDeveloperMap, /operatorAction/);
  ...
  assert.match(localServicesDeveloperMap, /local_services_workspace_api/);
  assert.match(localServicesDeveloperMap, /browser-local preview fallback/);
  ...
  assert.match(localServicesAgentHandoff, /\/v1\/local-services\/workspace/);
  assert.match(localServicesAgentHandoff, /LocalServicesWorkspaceAdapter/);
  assert.match(localServicesAgentHandoff, /local-services-workspace-adapter\.ts/);
  assert.match(localServicesAgentHandoff, /local-services-scenarios\.ts/);
  assert.match(localServicesAgentHandoff, /DEFAULT_LOCAL_SERVICES_SCENARIOS/);
  assert.match(localServicesAgentHandoff, /local_services_scenario_modal/);
  assert.match(localServicesAgentHandoff, /Export scenarios JSON/);
  assert.match(localServicesAgentHandoff, /LOCAL_SERVICES_WORKSPACE_STORAGE_KEY/);
  assert.match(localServicesAgentHandoff, /\/v1\/local-services\/cases/);
  assert.match(localServicesAgentHandoff, /Open workspace API export/);
  assert.match(localServicesAgentHandoff, /Workspace API export drawer/);
  assert.match(localServicesAgentHandoff, /exportPilotPacket\(\)/);
  assert.match(localServicesAgentHandoff, /local_services_workspace_api/);
  assert.match(localServicesAgentHandoff, /browser_local_preview/);
  assert.match(localServicesAgentHandoff, /apps\/api-backend/);
  assert.match(localServicesAgentHandoff, /React 18/);
  assert.match(localServicesAgentHandoff, /React 19/);
  assert.match(localServicesAgentHandoff, /Nothing is sent, booked, dispatched, billed, or written to CRM/);
  assert.match(localServicesAgentHandoff, /Current setup wizard contract/);
  assert.match(localServicesAgentHandoff, /Next setup action/);
  assert.match(localServicesAgentHandoff, /requiredInputs/);
  assert.match(localServicesAgentHandoff, /validationRule/);
  assert.match(localServicesAgentHandoff, /operatorAction/);
  assert.match(localServicesAgentHandoff, /Setup validation checklist/);
  assert.match(localServicesAgentHandoff, /Complete current step/);
  assert.match(localServicesAgentHandoff, /no phone activation, Telegram send, CRM write/);
  ...
  assert.match(outreachExecutionPack, /local_services_current_account_mini_audit/);
  assert.match(outreachExecutionPack, /Open account history/);
  assert.match(outreachExecutionPack, /local_services_account_history_drawer/);
