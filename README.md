...
- Job summary includes strict badge evidence statuses extracted from `artifacts/demo-e2e/badge-details.json`: `operatorTurnTruncation`, `operatorTurnDelete`, `operatorDamageControl`, `governancePolicy`, `skillsRegistry`, and `deviceNodes`.
...
- Job summary includes badge evidence statuses for `operatorTurnTruncation`, `operatorTurnDelete`, `operatorDamageControl`, `governancePolicy`, `skillsRegistry`, and `deviceNodes` from `badge-details.json`.
