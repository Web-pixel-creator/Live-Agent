...
Status strip readability is tuned for judge demos with higher neutral-text contrast, stronger card separation, and pill-state color mapping for `Status`, `Session State`, `Mode`, `PTT`, and `Export`.
