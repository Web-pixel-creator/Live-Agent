...
function resolveExportMenuSummaryLabel(statusText) {
  ...
  if (kind === "markdown") {
    return "Export Session (MD)";
  }
  if (kind === "json") {
    return "Export Session (JSON)";
  }
  if (kind === "audio") {
    return "Export Session (WAV)";
  }
